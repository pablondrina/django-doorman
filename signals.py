"""
Doorman signals — Documented contracts (P6).
...
"""
Dispatched when a Customer successfully authenticates via Doorman.

Kwargs:
    customer (DoormanCustomerInfo): The authenticated customer.
...
Kwargs:
    ...
    customer (DoormanCustomerInfo): The target customer.
...
Kwargs:
    ...
    customer (DoormanCustomerInfo): The customer who verified.
