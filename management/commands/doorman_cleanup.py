...
Usage:
    python manage.py doorman_cleanup
    python manage.py doorman_cleanup --days=30
    python manage.py doorman_cleanup --dry-run
"""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if dry_run:
            ...
            from doorman.models import BridgeToken, MagicCode, TrustedDevice
