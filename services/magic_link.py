...
logger = logging.getLogger("doorman.magic_link")
...
class MagicLinkService:
    ...
    def send_magic_link(
        ...
        ttl = doorman_settings.MAGIC_LINK_TTL_MINUTES
    ...
    def _send_magic_link_email(
        ...
        try:
            ...
            text_body = render_to_string(
                doorman_settings.TEMPLATE_MAGIC_LINK_EMAIL_TXT, context
            )
            html_body = render_to_string(
                doorman_settings.TEMPLATE_MAGIC_LINK_EMAIL_HTML, context
            )
            ...
            logger.exception(f"Magic link email failed: {e}")
            return False
